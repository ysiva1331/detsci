<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <li class="parent "><a data-toggle="collapse" href="#sub-item-3">
            <em class="fa fa-navicon">&nbsp;</em>Revenue <span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="fa fa-plus"></em></span>
        </a>
        <ul class="children collapse" id="sub-item-3">
            <li><a class="" href="<?php echo site_url('Revenue/add');?>">
                <span class="fa fa-arrow-right">&nbsp;</span> Add Revenue
            </a></li>
            <li><a class="" href="<?php echo site_url('Revenue/manage');?>">
                <span class="fa fa-arrow-right">&nbsp;</span> Manage Revenue
            </a></li>
        </ul>
    </li>
    <li class="parent "><a data-toggle="collapse" href="#sub-item-4">
            <em class="fa fa-navicon">&nbsp;</em>Remainders <span data-toggle="collapse" href="#sub-item-4" class="icon pull-right"><em class="fa fa-plus"></em></span>
        </a>
        <ul class="children collapse" id="sub-item-4">
            <li><a class="" href="<?php echo site_url('Remainders/add');?>">
                <span class="fa fa-arrow-right">&nbsp;</span> Add Remainders
            </a></li>
            <li><a class="" href="<?php echo site_url('Remainders/manage');?>">
                <span class="fa fa-arrow-right">&nbsp;</span> Manage Remainders
            </a></li>
        </ul>
    </li>
