...
<head>
	...
	<title>Daily Expense Tracker || Add Remainder</title>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-12">
							<?php echo form_open('Remainders/add',['name'=>'addRemainder']);?>
							<div class="form-group">
								<label>Date of Remainder</label>
								<?php echo form_input(['name'=>'remainder_date','id'=>'remainder_date','class'=>'form-control','data-date-format'=>'yyyy-mm-dd','value'=>set_value('remainder_date')]);?>
