...
<head>
	...
	<title>Daily Revenue Tracker || Add Revenue</title>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-12">
							<?php echo form_open('Revenue/add',['name'=>'addRevenue']);?>
							<div class="form-group">
								<label>Date of Revenue</label>
								<?php echo form_input(['name'=>'revenuedate','id'=>'revenuedate','class'=>'form-control','data-date-format'=>'yyyy-mm-dd','value'=>set_value('revenuedate')]);?>
